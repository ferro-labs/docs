---
title: Configuration
description: "Complete v1.0.0 configuration reference for the Ferro Labs AI Gateway — routes, targets, 8 routing strategies, model aliases, all 11 plugins, MCP servers, and budget controls."
...
Copy [`config.example.yaml`](https://github.com/ferro-labs/ai-gateway/blob/main/config.example.yaml) from the repository for a full example covering all 29 providers, aliases, and all 11 plugins.
