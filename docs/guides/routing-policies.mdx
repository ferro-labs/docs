...
:::tip Pro tip
Conditional routing pairs well with [model aliases](/getting-started/configuration#model-aliases). Alias `smart` → `claude-3-5-sonnet-20241022`, then add a conditional rule for `model_prefix: claude`.
:::
