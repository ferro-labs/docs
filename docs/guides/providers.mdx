---
title: Providers
description: All 29 AI providers supported by the Ferro Labs AI Gateway — OpenAI, Anthropic, Gemini, Mistral, Groq, DeepSeek, Ollama, AWS Bedrock, Azure OpenAI, Cerebras, NVIDIA NIM, Cloudflare, Databricks, and more with virtual key routing.
...
The gateway supports 29 AI providers. A provider becomes active when its required environment variables are set — no code changes or rebuilds needed.
...
- **Embeddings** — OpenAI, Cohere, Mistral, Azure OpenAI, Hugging Face, Cloudflare Workers AI
