---
title: Changelog
description: "Release history for Ferro Labs AI Gateway v1.0.0 — stable release with 29 providers, 8 routing strategies, MCP streaming, content-based routing, A/B testing, and budget controls."
keywords: [AI gateway changelog, LLM proxy releases, AI gateway version history, AI gateway v1.0.0, gateway updates, MCP integration release]
---
