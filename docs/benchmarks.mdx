...
description: "AI gateway benchmark results: sub-millisecond p99 latency overhead at 500 RPS. Go-native AI Gateway vs Python-based LLM proxy performance."
keywords:
...
- [Routing policies](/guides/routing-policies) — configure the routing layer benchmarked above
